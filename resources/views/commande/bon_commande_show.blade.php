                ...
                <tbody>
                    ...
                    <tr v-for="(sectionnable, index) in bc.sectionnables" v-if="sectionnable.product">
                        ...
                        <td class="tw-bg-teal-600 tw-text-white">
                            ...
                            <input v-if="editMode || sectionnable.editMode"
                        ...
                        <td class=" tw-bg-indigo-600 tw-text-white">
                            <input
                                v-show="editMode || sectionnable.editMode"
                                {{-- @input="addEdited(sectionnable)" --}}
                            ...
                            >
                            <span v-if="! (editMode || sectionnable.editMode) && (sectionnable.pivot.prix_achat % commande.currency_exchange_rate !== 0 )">XAF @{{ (sectionnable.pivot.prix_achat * commande.currency_exchange_rate ).toFixed(1) }}</span>
                            <span v-if=" ! (editMode || sectionnable.editMode) && (sectionnable.pivot.prix_achat % commande.currency_exchange_rate === 0)">XAF @{{ (sectionnable.pivot.prix_achat * commande.currency_exchange_rate ).toFixed(0) }}</span>
                        </td>
                    ...
                    <tr v-for="sectionnable in bc.sectionnables" v-if="sectionnable.article">
                        ...
                        <td>AED @{{ sectionnable.pivot.prix_achat / commande.currency_exchange_rate }}</td>
                        <td>
                            AED
                            <animated-number :value="sectionnable.pivot.quantite * (sectionnable.pivot.prix_achat / commande.currency_exchange_rate )"
                                 :duration="500" />
                        </td>
                        <td class="tw-bg-gray-200">
                            {{-- Edit Mode --}}
                    ...
                    <tr>
                        ...
                        <td class="tw-bg-indigo-700 tw-text-indigo-100">
                            AED <animated-number :value="(montantTotal/commande.currency_exchange_rate).toFixed(0)"  :duration="500" />
                        </td>
                    </tr>
                </tbody>
            </table>
