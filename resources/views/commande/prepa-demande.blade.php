...
<prepa-demande :commande_prop="{{$commande}}" :commandes_prop="{{ $commandes }}" :fournisseurs_prop="{{$fournisseurs}}" inline-template>
    <div class="tw-flex tw-flex-col">
        ...
        <div class="tw-flex">
            ...
            <div class="tw-mx-auto tw-container-fluid tw-w-full tw-bg-gray-300">
                ...
                <div class="tw-mt-24 tw-bg-gray-500 tw-py-10 tw-w-full">
                    ...
                    <button v-if="! demande_banner " class="tw-btn tw-bg-green-500 tw-text-white tw-leading-none tw-ml-5" @click="demande_banner = true" >Voir Demandes</button>
                    <button v-if=" demande_banner " class="tw-btn tw-bg-green-500 tw-text-white tw-leading-none tw-ml-5" @click="demande_banner = false" >Cacher Demandes</button>
                </div>
                        ...
                        <tbody>
                                    ...
                                    <td v-if="produit.pivot.traduction">
                                        <span class="tw-flex tw-items-center tw-justify-between">
                                            <span class="tw-w-full">
                                                ...
                                                <input v-else type="text" class="form-control tw-w-full tw-inline-block" v-model="produit.pivot.traduction">
                                            </span>
                                            <span>
                                                <i v-if="! produit.editing" class="fas fa-pen tw-mx-3 tw-cursor-pointer tw-text-blue-600"
                                    ...
                                    <td scope="row" v-else>
                                        ...
                                        <span class="tw-flex tw-items-center tw-justify-between">
                                            <span v-if="! produit.editing && produit.handle && produit.handle.translation">
                                                ...
                                                <span v-if="produit.handle.display2">/ @{{
                                                    produit[produit.handle.display2] }}</span>
                                                <span v-if="produit.handle.display3">/ @{{
                                                    produit[produit.handle.display3] }}</span>
                                            </span>
                                            <input v-else type="text" class="form-control tw-w-full tw-inline-block" v-model="produit.pivot.traduction">
                                            <i v-if="! produit.editing" class="fas fa-pen tw-mx-3 tw-cursor-pointer tw-text-blue-600" @click="editTraduction(produit)"></i>
                                            <i v-else class="fas fa-save tw-mx-3 tw-cursor-pointer tw-text-blue-600" @click="saveTraduction(produit)"></i>
                                        </span>
                                    </td>
                            ...
                            <template v-for="article in section.articles">
                                <tr :class=" article.demandes.length > 0 ? 'tw-text-red-500' : '' ">
                                    ...
                                    <td class="tw-ml-3">
                                        <i class="fas fa-chevron-down tw-cursor-pointer" v-if="article.displayDetails" @click="toggleRow(article)"></i>
                                    ...
                                    <td>
                                        @{{ article.nom }}
                                        <button class="tw-bg-green-500 tw-px-3" @click="transferNameAsTraduction(article)">
                                    ...
                                    <td >
                                        <span class="tw-flex tw-items-center tw-justify-between">
                                            <span class="tw-w-full">
                                                ...
                                                <input v-else type="text" class="form-control tw-w-full tw-inline-block" v-model="article.pivot.traduction">
                                            </span>
                                            <span>
                                                <i v-if="! article.editing" class="fas fa-pen tw-mx-3 tw-cursor-pointer tw-text-blue-600"
                                ...
                                <tr v-if="article.displayDetails">
                                    ...
                                    <td colspan=1 class=" tw-bg-gray-700 tw-text-white">
                                        ...
                                        <ul>
                                            <li v-for="demande in article.demandes" class="tw-flex tw-items-center tw-justify-between">
                                                <span>@{{ demande.nom }}</span>
                                                <i class="tw-text-red-500 fas fa-trash tw-cursor-pointer tw-ml-3" @click="remove(article, demande)"></i>
                                            </li>
                                        </ul>
                                    </td>
                                </tr>
        ...
        <div
            ref="modal"
            v-show="magicSelectorModal"
            class="tw-relative tw-z-10" aria-labelledby="modal-title"
            role="dialog" aria-modal="true"
            @keydown.escape="closeMagicSelectorModal"
            tabindex="-1"
        >
                    ...
                    <div
                        ...
                        <div>
                            <div
                                ...
                                <select name="" id="">
                                    <option value="" v-for="section in commande.sections">@{{ section.nom }}</option>
                                </select>
                            </div>
                            <div class="tw-mt-3 tw-text-center sm:tw-mt-5">
                                {{-- TITRE --}}
                                <h3 class="tw-text-lg tw-leading-6 tw-font-medium tw-text-gray-900" id="modal-title">Payment
                                    successful</h3>
                                <div class="tw-mt-2">
                                    <!-- This example requires Tailwind CSS v2.0+ -->
