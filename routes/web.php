...
Route::get('/test', function(){
    ...
    return Sectionnable::where('sectionnable_id', '4e63b8aa-852d-4cdd-ae8c-767dfe3658b5')->with('product')->first();
...
Route::middleware(['auth'])->group(function () {
    ...
    */
    ...
    Route::put('article-update', function( Request $request){
        // return $request->all();
        $art = DB::table('sectionnables')->where('id', $request['article']['id'])->update([
